...
export DEPLOY_PATH="${DEPLOY_PATH:-/home/yuanrong/master}"
# The all-in-one image supplies the node log path; master/frontend use their
# own fixed role directory, as in the legacy launcher.
